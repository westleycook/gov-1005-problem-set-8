...
# Filtering for just the first 11 months
...
# Plotting the upper left corner
...
# Plotting the bottom left corner

p4 <- multiple_regression %>% 
...
# switched order from assignment prompt to put poll quality plots on top and
# tweet plots on bottom
